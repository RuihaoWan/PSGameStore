				...
				<form:form method="post" action="${url}" modelAttribute="productForm" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<form:label path="productCategory">Product Category</form:label>
						 ...
						 -->
						<div class="form-group">
						<form:label path="platform">Product Platform</form:label>
								 <form:radiobutton path="platform" value="PS4"/>PS4
								 <form:radiobutton path="platform" value="XboxOne"/>XboxOne
								 <form:radiobutton path="platform" value="Switch"/>Switch
						</div>
						<div class="form-group">
						<form:label path="quality">Product Quality</form:label>
								 <form:radiobutton path="quality" value="New"/>New
								 <form:radiobutton path="quality" value="Good"/>Used - Very Good
								 <form:radiobutton path="quality" value="Acceptable"/>Used - Acceptable
								 <form:radiobutton path="quality" value="Bad"/>Used - Imperfect
						</div>
						<div class="row">
